...
dataset
dataloader
transform(pitch 변경(librosa effects pitch_shift), masking, )
torchaudio.transforms.FrequencyMasking/TimeMasking . augment는 training에만 적용.
mix-up/manifold mix-up
학습전 전처리 저장 과 학습도중 전처리의 장단점.

etc/tip
waveform을 normalizing 하면 성능이 오르는 경향이 있음.

***
   ref)MLA

   https://www.compadre.org/osp/EJSS/4485/270.htm
   https://www.onosokki.co.jp/English/hp_e/whats_new/SV_rpt/SV_7/sv7.htm
